...
class EventifyApiService
{
    ...
    public function comercios(array $filters = []): array
    {
        ...
        return Cache::remember($key, now()->addSeconds(0), function () use ($filters) {
    ...
    {
        return Cache::remember("api_comercio_{$slug}", now()->addSeconds(0), function () use ($slug) {
    ...
    {
        return Cache::remember('api_localidades', now()->addSeconds(0), function () {
    ...
    {
        return Cache::remember("api_localidad_{$slug}", now()->addSeconds(0), function () use ($slug) {
    ...
    {
        return Cache::remember('api_categorias', now()->addSeconds(0), function () {
    ...
    {
        return Cache::remember('api_asociaciones', now()->addSeconds(0), function () {
    ...
    {
        return Cache::remember("api_asociacion_{$slug}", now()->addSeconds(0), function () use ($slug) {
    ...
    {
        return Cache::remember('api_stats', now()->addSeconds(0), function () {
